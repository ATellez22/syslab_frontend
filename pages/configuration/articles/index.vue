              ...
              <div class="card-body">
                <table class="table">
                  <thead>
                    ...
                    <th class="py-0 px-1">Stock Minimo</th>
                  ...
                  <tbody>
                    ...
                    <tr v-for="(elemento) in list">
                      ...
                      <td class="py-0 px-1">
                        {{ elemento.measure.description }}
                      </td>
                      <td class="py-0 px-1">{{ elemento.minimum_stock }}</td>
                      <td class="py-0 px-1">
                        <div class="btn-group">
  ...
  mounted() {
    ...
    this.$nextTick(async () => {
      ...
      */
      ...
      try {
        await Promise.all([this.GET_DATA("articles")]).then((position) => {
          //La promesa resuelta 'position' se trasfiere a 'list' desde su primer valor '0'.
          this.list = position[0];
        });
      } catch (error) {
