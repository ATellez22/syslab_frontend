          ...
          <div class="col-12 col-sm-7">
            <div class="row">
                      ...
                      <div class="col-lg-4 col-md-6 col-12">
                        <div class="input-group input-group-lg">
                          ...
                          <input type="text" class="form-control bg-transparent border-0 text-white"
                            placeholder="Buscar..." v-model="find" @keyup.enter="Codebar()" />
                        </div>
                      </div>
                      <div class="col-lg-6 col-md-6 col-12 my-auto ms-auto">
                        <div class="input-group input-group-lg">
                          ...
                          <select name="" id="" class="form-control bg-transparent border-0 text-white" v-model="brand">
                            ...
                            <option class="text-dark" v-for="elemento in brands_list" :value="elemento.id">
              ...
              <div class="col-12 py-2" style="
                ...
                ">
                <div class="row">
                  <div class="col-3" v-for="elemento in articlesCategoriesFilter">
                    ...
                    <div class="dropdown pt-2">
                      ...
                      <ul class="dropdown-menu dropdown-menu-end me-sm-n4 px-2 py-3" aria-labelledby="dropdownCam"
                        ...
                        <li v-for="elemento in categories_list">
                          <a class="dropdown-item border-radius-md" href="javascript:;" @click="category = elemento.id">{{
                  ...
                  <div class="row">
                    ...
                    <div class="col-6">
                      <div class="form-group has-success">
                        ...
                        <input type="text" placeholder="" class="form-control" v-model.number="item.purchase_price" />
                      </div>
                    </div>
                    <div class="col-6">
                      <div class="form-group has-success">
                    ...
                    <div class="col-6">
                      <div class="form-group has-success">
                        ...
                        <input type="text" placeholder="" class="form-control" v-model.number="item.quantity" />
                      </div>
                    </div>
                  </div>
                </div>
    ...
    async Save() {
      ...
      try {
        ...
        const operation = {
          ...
          type:1,
          reason:'',
          supplier:'PUBLICO GENERAL',
          cart:this.cart
       }

        // Guardado directo para compras. Utilizar 'operation'.
        const res = await this.$api.$post("purchases", operation);

        // Sweet-alert2 para mostrar un mensaje de éxito
        console.log(res);
        this.$swal
          .fire({
